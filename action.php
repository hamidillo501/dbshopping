...
//Hisoblash foydalanuvchi savati item
...
//Savat elementini ma'lumotlar bazasidan ochiladigan menyuga olindi
if (isset($_POST["Common"])) {

	if (isset($_SESSION["uid"])) {
//Foydalanuvchi tizimga kirganda, bu so'rov bajariladi
		$sql = "SELECT a.product_id,a.product_title,a.product_price,a.product_image,b.id,b.qty FROM products a,cart b WHERE a.product_id=b.p_id AND b.user_id='$_SESSION[uid]'";
	}else{
//Foydalanuvchi tizimga kirmaganda bu so'rov bajariladi
		$sql = "SELECT a.product_id,a.product_title,a.product_price,a.product_image,b.id,b.qty FROM products a,cart b WHERE a.product_id=b.p_id AND b.ip_add='$ip_add' AND b.user_id < 0";
	}
	$query = mysqli_query($con,$sql);
	if (isset($_POST["getCartItem"])) {
// ochiladigan menyuda savat elementini ko'rsatishi
		if (mysqli_num_rows($query) > 0) {
			$n=0;
	...
	if (isset($_POST["checkOutDetails"])) {
		if (mysqli_num_rows($query) > 0) {
//Agar foydalanuvchi tizimga kirmagan bo'lsa, "To'lovga tayyor" tugmasi bilan 
// foydalanuvchi savatidagi elementni ko'rsatish
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/project1/payment_success.php"/>
									...
									<input style="float:right;margin-right:80px;" type="image" name="submit"
										...
										alt="Cilik - The safer, easier way to pay online">
								</form>';
				}
			}
	}
